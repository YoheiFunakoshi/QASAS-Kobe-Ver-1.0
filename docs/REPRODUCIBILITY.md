...
> BCR repertoires were compared with the specified antibody-sequence database using QASAS Kobe Ver 1.0 (`QASAS-Kobe-three-mode-1.0`, Kobe mode, Git commit `<hash>`). Candidate-aware allele-free IGHV/IGHJ calls and CDR3 amino-acid Levenshtein distances of 0–2 were used. Exact distance classes and cumulative values were reported separately.
